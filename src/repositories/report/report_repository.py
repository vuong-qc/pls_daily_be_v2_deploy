...
class ReportRepository(ABC):
    ...
    @abstractmethod
    async def get_list_reports(self, filters: FilterReportModel, actor_id: str, department_ids: list[str] | None = None) -> tuple[list[ReportDocument], int]: ...
    ...
    @abstractmethod
    async def get_user_not_contain_report(self, filters: FilterReportModel): pass