...
class TextFormatEnum(StrEnum):
    ...
    REMIND_CHECK_IN = "<font color=\"#CB1D21\"><b>{user}</b></font> nhớ check-in để bắt đầu ngày làm việc nhé!"
    REMIND_CHECK_OUT = "<font color=\"#CB1D21\"><b>{user}</b></font> trước khi về nhớ check-out nhé!"
